...
export default function Home({data}) {
  ...
  const dataComment = [{description:"Software Engenier", local:"London - UK",titule:"Olinda Nova",img:"/images/marmitero.jpg",content: "When the need for restructuring arrives, call us. We are here to get your project off the drawing board! We have a great experience in installation and managing office and home projects."},
  {description:"Princess", local:"London - UK", titule:"Joao Outro", img:"/images/nene.jfif", content:"All houses need some adjustments over time. We can help you with a worn down door lock, a broken door handle, a hinge without some screws, a garden to clean and a lot of other types of home maintenances."},
  {description:"Princess", local:"London - UK", titule:"Joao Outro", img:"/images/nene.jfif", content:"All houses need some adjustments over time. We can help you with a worn down door lock, a broken door handle, a hinge without some screws, a garden to clean and a lot of other types of home maintenances."}]
